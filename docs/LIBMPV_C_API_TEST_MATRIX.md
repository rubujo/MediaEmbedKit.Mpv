...
| --- | --- |
| 官方基準 | mpv v0.41.0 |
| 提供者對齊 | shinchiro `20260602` / mpv `f5d4d9b`；zhongfly `2026-06-01-f5d4d9b029` / mpv `f5d4d9b029` |
...
已比對 shinchiro git build `f5d4d9b` 與 zhongfly git build `f5d4d9b029`，未發現相對 stable v0.41.0 的公開 header 形狀差異。
