...
| --- | --- |
| 官方基準 | mpv v0.41.0 |
| 提供者對齊 | shinchiro `20260607` / mpv `71ebd08`；zhongfly `2026-06-07-43b14a4c9f` / mpv `43b14a4c9f` |
...
已比對 shinchiro git build `71ebd08` 與 zhongfly git build `43b14a4c9f`，未發現相對 stable v0.41.0 的公開 header 形狀差異。
