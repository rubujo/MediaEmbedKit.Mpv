...
| --- | --- |
| 官方基準 | mpv v0.41.0 |
| 提供者對齊 | shinchiro `20260610` / mpv `304426c`；zhongfly `2026-07-01-99b4c12ccc` / mpv `99b4c12ccc` |
...
已比對 shinchiro git build `304426c` 與 zhongfly git build `99b4c12ccc`，未發現相對 stable v0.41.0 的公開 header 形狀差異。
