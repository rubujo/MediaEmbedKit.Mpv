...
7. 使用 `tools/libmpv/Sync-ProviderDocs.ps1` 把 catalog 的 build / 查核日期同步到下游事實宣告型文件（`LIBMPV_C_API_TEST_MATRIX.md`、`HIGH_LEVEL_API.md`、`REFERENCE_SOURCES.md`）。release 前可加 `-Check` 模式作 drift gate。
