...
public sealed class ExternalToolRuntimeSource
{
    ...
    /// </summary>
    /// <param name="tool">外部工具種類。</param>
    /// <param name="platform">外部工具來源對應的平台。</param>
    /// <param name="name">外部工具來源的顯示名稱。</param>
    /// <param name="uri">外部工具來源的參考 URI。</param>
    /// <param name="assetName">外部工具來源的發行資產名稱。</param>
    /// <param name="status">此專案對該來源的支援狀態。</param>
    /// <param name="supportsSelfUpdate">外部工具是否提供自我更新命令。</param>
    /// <param name="updateCommand">外部工具自我更新命令範例。</param>
    /// <param name="note">外部工具來源的補充說明。</param>
