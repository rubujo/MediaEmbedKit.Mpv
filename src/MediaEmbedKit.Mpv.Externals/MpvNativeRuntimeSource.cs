...
public sealed class MpvNativeRuntimeSource
{
    ...
    /// </summary>
    /// <param name="platform">來源對應的原生平台。</param>
    /// <param name="name">原生來源的顯示名稱。</param>
    /// <param name="uri">原生來源的參考 URI。</param>
    /// <param name="kind">原生來源的取得方式。</param>
    /// <param name="status">此專案對該來源的支援狀態。</param>
    /// <param name="nativeLibraryName">該平台預期的原生程式庫名稱。</param>
    /// <param name="note">原生來源的補充說明。</param>
