...
public sealed class LibMpvUpdateResult
{
    ...
    /// libmpv 下載結果。
    /// </param>
    /// <param name="appliedToRuntimeDirectory">
    /// 更新是否已套用到執行階段資料夾。
    /// </param>
    /// <param name="requiresProcessRestart">
    /// 更新是否需要重新啟動處理序。
    /// </param>
    /// <param name="restartMessage">
    /// 重新啟動或套用更新的提示訊息。
    /// </param>
    ...
    /// </summary>
    /// <value>
    /// 已套用到執行階段資料夾時為 <see langword="true"/>。
    /// </value>
