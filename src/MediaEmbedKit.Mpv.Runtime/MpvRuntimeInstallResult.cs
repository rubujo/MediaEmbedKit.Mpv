...
public sealed class MpvRuntimeInstallResult
{
    ...
    /// </summary>
    /// <value>
    /// 支援狀態為 <see cref="MpvNativeRuntimeSupportStatus.Supported"/> 時為 <see langword="true"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// Windows 下載結果；未執行 Windows 安裝流程時為 <see langword="null"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// libmpv 檔案路徑；未安裝時為 <see langword="null"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// yt-dlp 可執行檔路徑；未安裝時為 <see langword="null"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// Deno 可執行檔路徑；未安裝時為 <see langword="null"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// FFmpeg 可執行檔路徑；未安裝時為 <see langword="null"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// FFprobe 可執行檔路徑；未安裝時為 <see langword="null"/>。
    /// </value>
