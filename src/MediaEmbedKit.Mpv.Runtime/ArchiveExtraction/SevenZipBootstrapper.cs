...
/// 官方 GitHub Releases 下載獨立版 <c>7zr.exe</c>（588 KB 32-bit x86）當終極備援。
/// </summary>
/// <remarks>
/// <para>
/// <c>7zr.exe</c> 是 7-Zip 原作者 Igor Pavlov 官方 repository
/// （<see href="https://github.com/ip7z/7zip"/>）發佈的獨立版 CLI 解壓工具，
/// 僅支援 .7z 格式但無 unrar 限制（純 LGPL-2.1+，可自由 redistribute）。它也是 ip7z
/// release 唯一可直接下載的 獨立版 CLI（其餘 <c>7za.exe</c> 在 <c>7z2601-extra.7z</c>
...
/// </para>
/// <para>
/// <strong>ARM64 注意</strong>：<c>7zr.exe</c> 是 32-bit x86 二進位檔。在 Windows on Arm
/// 透過 x86 模擬執行：Windows 11 ARM64 效能 OK；Windows 10 ARM64 模擬
/// 仍是 preview、較慢。ARM64 使用者若預先安裝 7-Zip ARM64 原生版（從
/// <see href="https://www.7-zip.org/download.html"/>），備援鏈會優先走第 3 段
