...
namespace MediaEmbedKit.Mpv
{
    ...
    public sealed class MpvCommandInfo
    {
        ...
        /// <param name="vararg">命令是否接受可變數量引數。</param>
        /// <param name="arguments">命令引數描述集合。</param>
