...
public sealed class MpvVideoParameters
{
    ...
    /// 像素格式。
    /// </param>
    /// <param name="hardwarePixelFormat">
    /// 硬體像素格式。
    /// </param>
    /// <param name="width">
    /// 編碼寬度。
    ...
    /// 立體視訊輸入模式。
    /// </param>
    /// <param name="averageBitsPerPixel">
    /// 平均每像素位元數。
    /// </param>
    /// <param name="rawNode">
    /// 原始節點資料。
    ...
    /// </summary>
    /// <value>
    /// 硬體像素格式；沒有資料時為 <see langword="null"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 顯示外觀比例；沒有資料時為 <see langword="null"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 像素外觀比例；沒有資料時為 <see langword="null"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 立體視訊輸入模式；沒有資料時為 <see langword="null"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 平均每像素位元數；沒有資料時為 <see langword="null"/>。
    /// </value>
