...
/// </para>
/// <list type="bullet">
/// <item><c>#RRGGBB</c> 或 <c>#AARRGGBB</c> 十六進位</item>
/// <item><c>0xRRGGBB</c> 或 <c>0xAARRGGBB</c></item>
/// <item>CSS 命名色彩（<c>red</c> / <c>cornflowerblue</c> 等）</item>
/// <item>浮點 RGBA：<c>0.5/0.5/0.5/1.0</c></item>
/// </list>
/// <para>
...
public static class MpvColor
{
    ...
    /// </summary>
    /// <param name="alpha">Alpha 值（0–255）。</param>
    /// <param name="red">紅色值（0–255）。</param>
    /// <param name="green">綠色值（0–255）。</param>
    /// <param name="blue">藍色值（0–255）。</param>
    /// <returns>mpv 接受的 <c>#AARRGGBB</c> 格式字串。</returns>
    ...
    /// <param name="green">綠色值（0–255）。</param>
    /// <param name="blue">藍色值（0–255）。</param>
    /// <returns>mpv 接受的 <c>#FFRRGGBB</c> 格式字串。</returns>
    ...
    /// </summary>
    /// <param name="input">輸入色彩字串。</param>
    /// <param name="normalized">解析成功時為 <c>#AARRGGBB</c> 格式字串；失敗時為原字串。</param>
    /// <returns>解析成功時為 <see langword="true"/>。</returns>
    ...
    /// </summary>
    /// <param name="hex">不含 <c>#</c> 或 <c>0x</c> 前綴的十六進位字串。</param>
    /// <param name="offset">起始字元偏移。</param>
    /// <param name="value">解析成功時的 byte 值。</param>
    /// <returns>解析成功時為 <see langword="true"/>。</returns>
