...
namespace MediaEmbedKit.Mpv
{
    ...
    public sealed class MpvCapabilities
    {
        ...
        /// </summary>
        /// <param name="clientApiVersion">由 libmpv 回報的 client API 版本。</param>
        /// <param name="mpvVersion">由 libmpv 回報的 mpv 版本字串。</param>
        /// <param name="mpvConfiguration">由 libmpv 回報的 mpv 編譯設定字串。</param>
        /// <param name="protocols">libmpv 目前支援的通訊協定名稱集合。</param>
        /// <param name="decoders">libmpv 目前支援的解碼器資訊集合。</param>
        /// <param name="demuxers">libmpv 目前支援的 demuxer 名稱集合。</param>
        ...
        /// </summary>
        /// <value>解析自 <see cref="MpvPlayer.ClientApiVersion"/> 的 major.minor 版本。</value>
        public Version ClientApiVersion { get; }

        /// <summary>
        /// 取得 libmpv 回報的 mpv 版本字串。
        /// </summary>
        /// <value>例如 <c>mpv 0.41.0</c> 或包含 provider git build 標記的版本文字。</value>
        public string MpvVersion { get; }

        /// <summary>
        /// 取得 libmpv 回報的 mpv 編譯設定字串。
        /// </summary>
        /// <value>來自 <c>mpv-configuration</c> 屬性的編譯選項字串。</value>
        public string MpvConfiguration { get; }

        /// <summary>
        /// 取得 libmpv 目前支援的通訊協定名稱集合。
        /// </summary>
        /// <value>例如 <c>file</c>、<c>http</c>、<c>https</c>、<c>ytdl</c>。</value>
        public IReadOnlyList<string> Protocols { get; }

        /// <summary>
        /// 取得 libmpv 目前支援的解碼器資訊集合。
        /// </summary>
        /// <value>對應 <c>decoder-list</c> 屬性的解碼器明細。</value>
        public IReadOnlyList<MpvDecoderInfo> Decoders { get; }

        /// <summary>
        /// 取得 libmpv 目前支援的 demuxer 名稱集合。
        /// </summary>
        /// <value>例如 <c>mp4</c>、<c>matroska</c>、<c>mpegts</c>。</value>
        public IReadOnlyList<string> Demuxers { get; }

        /// <summary>
        /// 判斷 libmpv 是否支援指定的通訊協定。
        /// </summary>
        /// <param name="scheme">要查詢的協定名稱，例如 <c>https</c>。</param>
        /// <returns>支援時為 <see langword="true"/>。</returns>
        ...
        /// </summary>
        /// <param name="name">要查詢的 demuxer 名稱。</param>
        /// <returns>包含時為 <see langword="true"/>。</returns>
        ...
        /// </summary>
        /// <param name="codec">要查詢的解碼器 codec 名稱，例如 <c>h264</c>。</param>
        /// <returns>包含時為 <see langword="true"/>。</returns>
