...
public sealed class MpvEndFileEventArgs : MpvEventArgs
{
    ...
    /// 目前播放項目結束的原因。
    /// </param>
    /// <param name="mpvErrorCode">
    /// 播放結束事件附帶的 libmpv 錯誤碼。
    /// </param>
    ...
    /// 播放清單項目的 libmpv 識別碼。
    /// </param>
    /// <param name="playlistInsertId">
    /// 因重新導向而插入的第一個播放清單項目識別碼。
    /// </param>
    /// <param name="playlistInsertNumEntries">
    /// 因重新導向而插入的播放清單項目數量。
    /// </param>
