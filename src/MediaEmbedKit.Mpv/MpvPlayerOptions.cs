...
public sealed class MpvPlayerOptions
{
    ...
    /// </summary>
    /// <value>
    /// libmpv 檔案路徑或包含 libmpv 的資料夾；未指定時會使用預設搜尋邏輯。
    /// </value>
    ...
    /// 指定外部工具所在的資料夾。
    /// </summary>
    /// <param name="toolDirectory">
    /// 包含 yt-dlp、Deno、FFmpeg 或 FFprobe 等工具的資料夾。
    /// </param>
    /// <returns>
    /// 目前的播放器選項。
    /// </returns>
    ...
    /// 要傳給 mpv <c>ytdl-format</c> 選項的 selector 字串。
    /// </param>
    /// <returns>
    /// 目前的播放器選項。
    /// </returns>
    ...
    /// </summary>
    /// <value>
    /// 啟用 yt-dlp 支援時為 <see langword="true"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 以分號分隔的 yt-dlp 或 youtube-dl 可執行檔路徑清單。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>ytdl-format</c> 選項的自訂 selector；未指定時使用 <see cref="YtdlpFormatPreset"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// input.conf 檔案路徑；未指定時使用 mpv 設定資料夾中的預設位置。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 載入腳本時為 <see langword="true"/>；未指定時使用 mpv 預設值。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>scripts</c> 選項的腳本檔案路徑集合。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 包含 yt-dlp、Deno、FFmpeg 或 FFprobe 等外部工具的資料夾。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// mpv 記錄等級文字，例如 <c>warn</c> 或 <c>info</c>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要使用的 <see cref="ILoggerFactory"/>；未設定時不啟用 ILogger 整合。
    /// </value>
    /// <remarks>
