...
public sealed class MpvRelayCommand : ICommand
{
    ...
    /// </summary>
    /// <param name="execute">執行指令時呼叫的委派。</param>
    /// <param name="canExecute">判斷指令是否可執行的委派；未指定時始終為 <see langword="true"/>。</param>
    ...
    /// </summary>
    /// <param name="execute">執行指令時呼叫的委派，接收 ICommand 參數。</param>
    /// <param name="canExecute">判斷指令是否可執行的委派；未指定時始終為 <see langword="true"/>。</param>
    ...
    /// 判斷指令目前是否可執行。
    /// </summary>
    /// <param name="parameter">ICommand 參數。</param>
    /// <returns>可執行時為 <see langword="true"/>。</returns>
