...
public sealed class MpvEditionInfo
{
    ...
    /// <param name="title">版本標題。</param>
    /// <param name="defaultEdition">版本是否為預設版本。</param>
    ...
    /// 取得版本索引。
    /// </summary>
    /// <value>以 0 為起始的版本索引。</value>
    public int Index { get; private set; }

    /// <summary>
    /// 取得版本識別碼。
    /// </summary>
    /// <value>版本識別碼；沒有資料時為 <see langword="null"/>。</value>
    public long? Id { get; private set; }

    /// <summary>
    /// 取得版本標題。
    /// </summary>
    /// <value>版本標題；沒有資料時為 <see langword="null"/>。</value>
    public string? Title { get; private set; }

    /// <summary>
    /// 取得版本是否為預設版本。
    /// </summary>
    /// <value>版本為預設版本時為 <see langword="true"/>。</value>
    public bool Default { get; private set; }

    /// <summary>
    /// 取得原始節點資料。
    /// </summary>
    /// <value>來自 mpv 的原始版本節點。</value>
    ...
    /// </summary>
    /// <param name="index">版本索引。</param>
    /// <param name="node">代表單一版本的節點。</param>
