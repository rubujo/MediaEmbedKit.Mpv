...
public sealed class MpvEncodingOptions
{
    ...
    /// mpv <c>of</c> 選項使用的容器格式。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// mpv <c>ofopts</c> 選項使用的 libavformat 參數字串。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// mpv <c>ovcopts</c> 選項使用的 libavcodec 視訊參數字串。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// </param>
    /// <param name="codecOptions">
    /// mpv <c>oacopts</c> 選項使用的 libavcodec 音訊參數字串。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// </summary>
    /// <param name="enabled">
    /// 需要保留輸入時間戳記時為 <see langword="true"/>。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// </summary>
    /// <param name="enabled">
    /// 需要複製輸入中繼資料時為 <see langword="true"/>。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// </summary>
    /// <param name="metadata">
    /// mpv <c>oset-metadata</c> 選項使用的中繼資料清單字串。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// </summary>
    /// <param name="metadata">
    /// mpv <c>oremove-metadata</c> 選項使用的中繼資料名稱清單字串。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// </summary>
    /// <param name="key">
    /// 中繼資料鍵名（例如 <c>title</c>、<c>artist</c>、<c>comment</c>）。
    /// </param>
    /// <param name="value">
    /// 中繼資料值。
    /// </param>
    ...
    /// mpv vf filter chain，例如 <c>scale=1280:720,fps=30</c>。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// </summary>
    /// <param name="filterChain">
    /// mpv af filter chain，例如 <c>aresample=48000,loudnorm</c>。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// libmpv 結構性僅支援 burn-in；不支援把字幕作為獨立軌道嵌入容器。
    /// </summary>
    /// <param name="subtitleFilePath">
    /// 字幕檔路徑（.srt / .ass / .vtt 等 mpv 支援格式）。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// </summary>
    /// <param name="name">
    /// libavformat muxer 選項名稱。
    /// </param>
    /// <param name="value">
    /// libavformat muxer 選項值。
    /// </param>
    /// <returns>
    /// 目前的 encoding mode 選項。
    /// </returns>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>of</c> 選項的容器格式；未指定時由 mpv 自行判斷。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>ofopts</c> 選項的 libavformat 選項字串。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>ovcopts</c> 選項的 libavcodec 視訊選項字串。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>oacopts</c> 選項的 libavcodec 音訊選項字串。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>orawts</c> 選項的旗標；未指定時使用 mpv 預設值。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>ocopy-metadata</c> 選項的旗標；未指定時使用 mpv 預設值。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>oset-metadata</c> 選項的 key/value 清單字串。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 要傳給 mpv <c>oremove-metadata</c> 選項的標籤清單字串。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// 以 mpv 選項名稱為索引鍵的額外 encoding 選項集合。
    /// </value>
    ...
    /// <c>
    /// WithMuxerOption</c> / <c>WithMetadataTag</c> / <c>WithoutMetadataTag
    /// </c>
    ...
    /// </summary>
    /// <param name="raw">
    /// 由 <see cref="RemoveMetadata"/> 設定的原始字串；可為 <see langword="null"/>。
    /// </param>
    /// <param name="additions">
    /// 透過 <see cref="WithoutMetadataTag"/> 累積的單一鍵名。
    /// </param>
    /// <returns>
    /// 合併後的字串；無任何輸入時為 <see langword="null"/>。
    /// </returns>
    ...
    /// </summary>
    /// <param name="raw">
    /// 由 <c>WithContainerOptions</c> / <c>WithVideoCodec</c> 等設定的原始字串；可為 <see langword="null"/>。
    /// </param>
    /// <param name="additions">
    /// 透過 <c>WithMuxerOption</c> / <c>WithVideoCodecOption</c> / <c>WithAudioCodecOption</c> 累積的單一鍵值對。
    /// </param>
    /// <returns>
    /// 合併後的字串；無任何輸入時為 <see langword="null"/>。
    /// </returns>
