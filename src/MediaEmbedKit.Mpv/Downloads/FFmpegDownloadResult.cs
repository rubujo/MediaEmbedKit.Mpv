...
namespace MediaEmbedKit.Mpv.Downloads
{
    ...
    public sealed class FFmpegDownloadResult
    {
        ...
        /// <param name="ffmpegPath">解壓縮後的 FFmpeg 可執行檔路徑。</param>
        /// <param name="ffprobePath">解壓縮後的 FFprobe 可執行檔路徑。</param>
        ...
        /// 取得 GitHub 發行標籤。
        /// </summary>
        /// <value>FFmpeg-Builds 發行標籤。</value>
        public string ReleaseTag { get; private set; }

        /// <summary>
        /// 取得已下載的發行資產名稱。
        /// </summary>
        /// <value>FFmpeg-Builds 發行資產名稱。</value>
        public string AssetName { get; private set; }

        /// <summary>
        /// 取得發行資產下載 URI。
        /// </summary>
        /// <value>FFmpeg-Builds 發行資產下載 URI。</value>
        public Uri DownloadUri { get; private set; }

        /// <summary>
        /// 取得下載後的壓縮檔路徑。
        /// </summary>
        /// <value>FFmpeg-Builds 壓縮檔路徑。</value>
        public string ArchivePath { get; private set; }

        /// <summary>
        /// 取得 FFmpeg 可執行檔路徑。
        /// </summary>
        /// <value>FFmpeg 可執行檔路徑。</value>
        public string FFmpegPath { get; private set; }

        /// <summary>
        /// 取得 FFprobe 可執行檔路徑。
        /// </summary>
        /// <value>FFprobe 可執行檔路徑。</value>
