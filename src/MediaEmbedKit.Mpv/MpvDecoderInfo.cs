...
namespace MediaEmbedKit.Mpv
{
    ...
    public sealed class MpvDecoderInfo
    {
        ...
        /// </summary>
        /// <param name="codec">解碼器支援的編解碼器名稱。</param>
        /// <param name="description">解碼器描述。</param>
        /// <param name="driver">解碼器驅動程式名稱。</param>
        ...
        /// 取得解碼器支援的編解碼器名稱。
        /// </summary>
        /// <value>編解碼器名稱；沒有資料時為 <see langword="null"/>。</value>
        public string? Codec { get; private set; }

        /// <summary>
        /// 取得解碼器描述。
        /// </summary>
        /// <value>解碼器描述；沒有資料時為 <see langword="null"/>。</value>
        public string? Description { get; private set; }

        /// <summary>
        /// 取得解碼器驅動程式名稱。
        /// </summary>
        /// <value>解碼器驅動程式名稱；沒有資料時為 <see langword="null"/>。</value>
        ...
        /// 從 mpv 節點建立解碼器資訊。
        /// </summary>
        /// <param name="node">代表單一解碼器的節點。</param>
        /// <returns>解碼器資訊。</returns>
