...
namespace MediaEmbedKit.Mpv.Render
{
    ...
    public sealed class MpvOpenGlRenderContextOptions
    {
        ...
        /// </summary>
        /// <param name="getProcAddress">用來解析 OpenGL 函式位址的委派。</param>
