...
public sealed class MpvEncodingResult
{
    ...
    /// libmpv <c>EndFile</c> 事件回報的結束原因。
    /// </param>
    /// <param name="errorCode">
    /// libmpv 隨 <c>EndFile</c> 附帶的錯誤碼；無錯誤時為 <see cref="MpvErrorCode.Success"/>。
    /// </param>
    /// <param name="outputPath">
    /// 輸出檔案路徑。
    /// </param>
    /// <param name="outputBytes">
    /// 輸出檔案最終位元組大小；無檔案產生時為 0。
    /// </param>
    /// <param name="elapsed">
    /// 自編碼開始至 <c>EndFile</c> 之間實際經過的時間。
    /// </param>
    ...
    /// </summary>
    /// <value>
    /// 當 <see cref="EndReason"/> 為 <see cref="MpvEndFileReason.EndOfFile"/> 且 <see cref="ErrorCode"/> 為 <see cref="MpvErrorCode.Success"/> 時為 <see langword="true"/>。
    /// </value>
    ...
    /// </summary>
    /// <value>
    /// libmpv 錯誤碼；無錯誤時為 <see cref="MpvErrorCode.Success"/>。
    /// </value>
